...
<!-- MAIN CONTENT -->
<div class="container" x-data="suratMasukApp()">
        ...
        <div class="card-body">
            ...
            <div class="search-filter">
                <div class="search-box">
                    ...
                    <input type="text" placeholder="Cari nomor surat, pengirim, atau perihal..." x-model="searchQuery">
                </div>
                    ...
                    <tbody>
                        <template x-for="(surat, index) in filteredSurat" :key="surat.id">
                            <tr>
                                ...
                                <td x-text="surat.pengirim"></td>
                                <td x-text="surat.perihal"></td>
                                <td>
                                    <span class="badge" :class="{
                                        'badge-warning': surat.status === 'pending',
                                        'badge-success': surat.status === 'processed',
                                        'badge-info': surat.status === 'archived'
    ...
    <div class="modal" :class="{ 'show': showModal }">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" x-text="modalMode === 'add' ? 'Tambah Surat Masuk' : 'Detail Surat Masuk'"></h3>
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" x-model="formData.nomor" placeholder="Contoh: 001/SKP/I/2026">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" x-model="formData.pengirim" placeholder="Nama instansi/lembaga pengirim">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Perihal *</label>
                        <textarea class="form-control" x-model="formData.perihal" placeholder="Perihal surat"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" x-model="formData.catatan" placeholder="Catatan tambahan (opsional)"></textarea>
                    </div>
                    <div class="form-group">
...
function suratMasukApp() {
    return {
        ...
        suratList: [
            {
                id: 1,
                nomor: '001/SKP/I/2026',
                tanggal: '05/01/2026',
                pengirim: 'Dinas Pendidikan Kota Semarang',
                perihal: 'Undangan Rapat Koordinasi',
                status: 'pending'
            },
            {
                id: 2,
                nomor: '002/BPKAD/I/2026',
                tanggal: '06/01/2026',
                pengirim: 'BPKAD Kota Semarang',
                perihal: 'Permintaan Data Anggaran',
                status: 'processed'
            },
            {
                id: 3,
                nomor: '003/DPUPR/I/2026',
                tanggal: '07/01/2026',
                pengirim: 'Dinas PU dan PR',
                perihal: 'Koordinasi Pembangunan Infrastruktur',
                status: 'pending'
            },
            {
                id: 4,
                nomor: '004/DISKOMINFO/XII/2025',
                tanggal: '20/12/2025',
                pengirim: 'Diskominfo Kota Semarang',
                perihal: 'Laporan Implementasi Sistem Digital',
                status: 'archived'
            },
            {
                id: 5,
                nomor: '005/KECAMATAN/I/2026',
                tanggal: '04/01/2026',
                pengirim: 'Kecamatan Gayamsari',
        ...
        get filteredSurat() {
            ...
            if (this.searchQuery) {
                result = result.filter(s => 
                    ...
                    s.pengirim.toLowerCase().includes(this.searchQuery.toLowerCase()) ||
